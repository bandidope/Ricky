...
handler.before = async function (m, { conn, participants, groupMetadata}) {
    ...
    const fkontak = {
        ...
        message: {
            locationMessage: {
                name: "*𝐑𝐢𝐜𝐤𝐲 𝐏𝐫𝐞𝐦 𝐁𝐨𝐭 🌀*",
                jpegThumbnail: await (await fetch('https://h.uguu.se/fNdkWNhf.png')).buffer(),
                vcard:
                    "BEGIN:VCARD\n" +
                    "VERSION:3.0\n" +
                    "N:;Storm bot;;;\n" +
                    ...
                    "TITLE:\n" +
                    "item1.TEL;waid=15812903813:+1 (581) 290-3813\n" +
    ...
    let pp = await conn.profilePictureUrl(m.chat, 'image').catch(_ => null) || 'https://h.uguu.se/fNdkWNhf.png'
